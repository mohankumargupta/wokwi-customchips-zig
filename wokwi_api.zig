...
pub extern fn pinMode(pin: PinId, mode: u32)  void;
pub extern fn pinRead(pin: PinId) u32;
pub extern fn pinWrite(pin: PinId, value: u32)  void;
pub extern fn pinWatch(pin: PinId, watch_config: ?*WatchConfig) bool;
pub extern fn pinWatchStop(pin: PinId)  void;
pub extern fn pinADCRead(pin: PinId) f32;
pub extern fn pinDACWrite(pin: PinId, value: f32)  void;
pub extern fn getSimNanos() f64;
pub extern fn timerInit(timer_config: ?*TimerConfig) TimerId;
pub extern fn timerStart(timer: TimerId, micros: u32, repeat: bool) void;
pub extern fn timerStartNanos(timer: TimerId, nanos: f64, repeat: bool) void;
...
pub extern fn spiStart(dev: SPIDevId, buffer: [*:0]const u8, count: u32)  void;
...
pub extern fn debugPrint(message: [*:0]const u8) void;